...
const FallingText: React.FC<FallingTextProps> = ({
    ...
    const newHTML = lines
      .map((line, index) => {
        ...
        const lineClass = (() => {
          ...
          if (index === 1)
            return "text-[28px] md:text-[82px] lg:text-[108px] flex flex-wrap gap-x-2 text-neutral-400 mb-2";
          if (index === 2)
            return "text-[28px] md:text-[64px] lg:text-[64px] flex flex-wrap gap-x-2 text-neutral-400 mb-2";
          if (index === 3)
  ...
  return (
    <div
      ref={containerRef}
      className="relative z-[1] w-full h-full cursor-pointer flex items-center overflow-hidden"
